        ...
        <div class="row justify-content-start">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('update-education', $items->id) }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-1 d-flex align-items-center justify-content-start">
                                    <input id="isactive" type="checkbox" class="form-control-sm @error('isactive') is-invalid @enderror mr-2" 
                                    name="isactive" autocomplete="isactive" autofocus {{ $items->isactive === 'Y' ? 'checked' : '' }}>
