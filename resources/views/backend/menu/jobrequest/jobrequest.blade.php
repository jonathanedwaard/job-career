                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('create-jobrequest') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <textarea id="requirement" type="text" class="form-control @error('requirement') is-invalid @enderror" name="requirement" required autocomplete="requirement" autofocus></textarea>
