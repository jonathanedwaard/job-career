...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-start">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Update Job Request</div>

                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('update-jobrequest', $items->id) }}">
                            @csrf
                                ...
                                <div class="col-md-4">
                                    <select id="jobtitle" class="form-control @error('jobtitle') is-invalid @enderror" name="jobtitle" required autocomplete="jobtitle" autofocus>
                                        ...
                                        @foreach ($jobtitle as $item)    
                                            <option value="{{ $item->id }}" {{ $items->jobtitle === $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4">
                                    <select id="jobtype" class="form-control @error('jobtype') is-invalid @enderror" name="jobtype" required autocomplete="jobtype" autofocus>
                                        ...
                                        @foreach ($jobtype as $item)    
                                            <option value="{{ $item->id }}" {{ $items->jobtype === $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4">
                                    <select id="location" class="form-control @error('location') is-invalid @enderror" name="location" required autocomplete="location" autofocus>
                                        ...
                                        @foreach ($location as $item)    
                                            <option value="{{ $item->id }}" {{ $items->location === $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4">
                                    <select id="education" class="form-control @error('education') is-invalid @enderror" name="education" required autocomplete="education" autofocus>
                                        ...
                                        @foreach ($education as $item)    
                                            <option value="{{ $item->id }}" {{ $items->education === $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4">
                                    <select id="workexperience" class="form-control @error('workexperience') is-invalid @enderror" name="workexperience" required autocomplete="workexperience" autofocus>
                                        ...
                                        @foreach ($workexperience as $item)    
                                            <option value="{{ $item->id }}" {{ $items->workexperience === $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input id="quota" type="number" class="form-control @error('quota') is-invalid @enderror" name="quota" value="{{ $items->quota }}" required autocomplete="quota" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input id="salary" type="number" class="form-control @error('salary') is-invalid @enderror" name="salary" value="{{ $items->salary }}" required autocomplete="salary" autofocus>
